...
function bearer(token: string): Request {
  return new Request("https://xuremiflow.test/eve/agents/runtime/eve/v1/session", {
    method: "POST",
...
describe("runtimeAgentHost", () => {
  it("points at the agent's mount path under APP_ORIGIN, with no double slash", () => {
    process.env.APP_ORIGIN = "https://xuremiflow.test/";
    expect(runtimeAgentHost()).toBe("https://xuremiflow.test/eve/agents/runtime");
  });
