...
export const metadata: Metadata = {
  title: "Xuremi Flow — automate your work with a canvas, not a codebase",
...
const STEPS = [
  {
    title: "Connect",
    body: "Paste an API key or a bot token. Xuremi Flow calls the provider to check it before saving, keeps the last four characters for the label, and seals the rest.",
  },
  {
    title: "Build",
