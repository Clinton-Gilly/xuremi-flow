...
export const metadata: Metadata = {
  title: "Pricing — Xuremi Flow",
  description: DESCRIPTION,
  openGraph: {
    type: "website",
    url: "/pricing",
    siteName: "Xuremi Flow",
    title: "Pricing — Xuremi Flow",
    description: DESCRIPTION,
  },
  twitter: {
...
const FAQ = [
  {
    ...
    answer:
      "Yes, and that is the point. You add an OpenAI, Anthropic, Gemini or Groq key as a connection, Xuremi Flow tests it and seals it, and the AI nodes call the provider as you. Model usage lands on your provider bill at their price, so your plan here never changes because a workflow got chatty.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "An Approval node posts a message with buttons to Slack, Discord or Telegram and then parks the run. Whoever presses a button resumes it exactly where it stopped, with the answer available to every node downstream. Nobody needs a Xuremi Flow account to press the button.",
  },
  {
