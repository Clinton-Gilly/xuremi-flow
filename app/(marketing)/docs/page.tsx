...
const QUICKSTART = [
  ...
  },
  {
    ...
    body: "Connections → Add. Pick a provider, paste the credential, and Xuremi Flow calls the provider to check it before saving. Only the last four characters are ever shown again.",
  },
  {
