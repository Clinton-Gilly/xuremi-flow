...
// user sees "Xuremi Flow connected" in the channel, which is a better proof than a green tick.
  ...
  async test(secret) {
    ...
    try {
      response = await fetch(webhookUrl, {
        ...
        body: JSON.stringify(adaptiveCardMessage([{ type: "TextBlock", text: "Xuremi Flow connected" }])),
