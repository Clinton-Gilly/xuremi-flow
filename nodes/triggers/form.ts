...
/**
 * The hosted form trigger: Xuremi Flow renders a public page at `/f/<workflowId>` from the field list
...
export const formTriggerNode = defineNode({
  ...
  guide: {
    summary:
      "Xuremi Flow hosts this form for you — the link is just below. Share it, and each submission starts a run. Publish the workflow first: a draft form still renders, but its submissions go nowhere yet.",
  },
  category: "trigger",
  icon: "ClipboardList",
  credential: null,
