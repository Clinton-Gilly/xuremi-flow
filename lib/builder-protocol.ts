 ...
 * at.
 */
export const BUILDER_WORKFLOW_HEADER = "x-xuremi-flow-workflow";
export const BUILDER_CONNECTION_HEADER = "x-xuremi-flow-connection";
export const BUILDER_MODEL_HEADER = "x-xuremi-flow-model";
